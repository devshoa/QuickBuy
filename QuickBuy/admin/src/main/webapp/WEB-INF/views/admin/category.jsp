...
<!-- Top Bar End -->
<title>Quản lý danh mục | QuickBuy</title>
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<form:input type="number" path="categoryID"
												cssClass="form-control" placeholder="123" disabled="true" />
										</div>
									</div>
									<div class="form-group row">
										<label for="example-password-input"
											class="col-sm-2 col-form-label"> Tên Danh Mục </label>
										<div class="col-sm-10">
											<form:input type="text" path="categoryName"
												cssClass="form-control" placeholder="Áo" />
											<span> <form:errors path="categoryName"
													cssClass="error" />
											</span>
										</div>
									</div>
								...
								<div class="col-xl-12">
									<div class="input-group-append mt-3">
										<button class="btn btn-primary ml-3"
											formaction="admin/category/create">Thêm mới</button>
										<button class="btn btn-primary ml-3"
										...
										<button class="btn btn-primary ml-3"
											formaction="admin/category">Đặt lại</button>
									</div>
								</div>
							</div>
						</form:form>
							...
							<tbody>
								<c:forEach var="item" items="${items}">
									<tr>
										...
										<td>
											<a href="admin/category/edit/${item.categoryID}" class="btn btn-sm btn-success text-white">
		...
		<div class="modal fade" id="delete" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">Bạn muốn xóa danh mục này và không
						thể hoàn tác! Bạn có muốn tiếp tục không?</div>
					<div class="modal-footer">
						<a href="admin/category/delete/${item.categoryID}" class="btn btn-primary"> Có,
